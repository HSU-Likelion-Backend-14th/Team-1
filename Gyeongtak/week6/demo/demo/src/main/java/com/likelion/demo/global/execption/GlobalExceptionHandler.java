...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse<?>>handleMissingServletRequestPArtException(MethodArgumentNotValidException e){
    ...
    public ResponseEntity<ErrorResponse<?>>handleHttpRequestMethodNotSupportException(HttpMessageNotReadableException e){
        log.error("MissingServletRequestParameterException : {}", e.getMessage(), e);
    ...
    public ResponseEntity<ErrorResponse<?>>handleNoResourceFoundException(NoHandlerFoundException e){
        log.error("NoHandlerFoundException : {}", e.getMessage(), e);
        ErrorResponse<?> errorResponse = ErrorResponse.from(ErrorResponseCode.NOT_FOUND_ENDPOINT);
        return ResponseEntity.status(errorResponse.getHttpStatus()).body(errorResponse);
    }
